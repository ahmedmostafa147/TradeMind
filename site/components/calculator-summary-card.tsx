        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            <button
              ...
              className="flex-1 rounded-lg border border-border-default bg-surface-high py-2 px-2.5 text-center text-xs font-bold text-fg hover:bg-surface-subtle transition-colors"
            >
          ...
          {onTradeCreate && (
            <button
              ...
              className="mt-3 w-full rounded-xl bg-brand py-3 text-center text-sm font-extrabold text-on-brand shadow-md hover:brightness-105 transition-all"
            >
              ✨ إنشاء الصفقة
            </button>
          )}
