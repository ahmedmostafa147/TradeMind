...
export const faq = [
  {
    ...
    a: 'أول ما تسجّل بتاخد 14 يوم تجربة كل حاجة فيها مفتوحة، من غير ما تدفع حاجة ومن غير ما تدخّل بطاقة. بعدها: تسجيل الصفقات ومتابعتها وحاسبة الصفقة وحاسبة الهدف بتفضل مجانية للأبد. اللي بيحتاج اشتراك هو تدفّقات السوق، وأسعار الأسهم، وقراءة التوصيات بالذكاء الاصطناعي، وشاشات الأداء والتحليلات. ومفيش إعلانات ولا أدوات تتبّع في الحالتين.',
  },
  {
