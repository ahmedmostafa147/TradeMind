...
export default function DeleteAccountPage() {
  return (
    <LegalPage title="حذف الحساب والبيانات">
      ...
      <p>
        ده بيمسح حسابك وكل صفقاتك وقائمة المراقبة وإعدادات المخاطرة فورًا
        ونهائيًا. ومفيش نسخة بتفضل على التليفون بعد الحذف — الدفتر بيتسجّل على
        حسابك بس، مش على الجهاز.
      </p>
