  ...
  return (
    <LegalPage title="سياسة الخصوصية" updatedAt={site.legalUpdatedAt}>
      ...
      <div className="callout">
        <strong>الأساس:</strong> التطبيق بيشتغل بالكامل من غير حساب. من غير
        تسجيل دخول، كل صفقاتك بتتخزّن على جهازك انت بس ومبتخرجش منه أبدًا.
        الحساب والنسخ الاحتياطي السحابي اختياريان تمامًا.
      </div>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>لو سجّلت حساب (بالبريد أو بحساب جوجل)</td>
              <td>لإنشاء حسابك وربط النسخة الاحتياطية بيه</td>
            </tr>
            <tr>
              <td>
              ...
              <td>لو سجّلت دخول وفعّلت النسخ الاحتياطي</td>
              <td>عشان تسترجع دفترك لو غيّرت أو فقدت جهازك</td>
            </tr>
            <tr>
      ...
      <ul>
        ...
        <li>
          <strong>على السحابة (اختياري):</strong> لو مسجّل دخول، صفقاتك بتتخزّن
          في Google Cloud Firestore تحت المسار{' '}
      ...
      <ul>
        <li>
          <strong>Google (Firebase)</strong> — للهوية والنسخ الاحتياطي، لو
          سجّلت دخول.
        </li>
        <li>
